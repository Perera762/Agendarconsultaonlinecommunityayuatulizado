...
import { Calendar, Clock, Stethoscope, LogOut, User, Plus, Moon, Sun } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <span className="text-slate-600 dark:text-slate-300">Olá, {patient?.fullName}</span>
              <button
                onClick={toggleTheme}
      ...
      <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          {/* Welcome Section */}
          <div className="mb-8">
            <h1 className="text-slate-900 dark:text-white mb-2">Portal do Paciente</h1>
            <p className="text-slate-600 dark:text-slate-400">Gerencie suas consultas e informações</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 transition-colors duration-300">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">Total de Consultas</p>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 transition-colors duration-300">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">Consultas Futuras</p>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 transition-colors duration-300">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">ID do Paciente</p>
                  <p className="text-slate-900 dark:text-white text-sm">{patient?.username}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 transition-colors duration-300">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-slate-900 dark:text-white">Minhas Consultas</h2>
              <button
                onClick={onNavigateToBooking}
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 text-white px-4 py-2 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 flex items-center gap-2"
              >
            ...
            {appointments.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-4">Você ainda não tem consultas agendadas</p>
                <button
                  onClick={onNavigateToBooking}
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 inline-flex items-center gap-2"
                >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <Stethoscope className={`w-5 h-5 ${upcoming ? 'text-blue-600 dark:text-blue-400' : 'text-slate-600 dark:text-slate-400'}`} />
                            <h3 className="text-slate-900 dark:text-white">{appointment.procedureName}</h3>
                          </div>

                          <div className="grid md:grid-cols-3 gap-4 text-sm">
                            <div>
                              <p className="text-slate-500 dark:text-slate-400 mb-1">Dentista</p>
                              <p className="text-slate-900 dark:text-white">{appointment.dentistName}</p>
                            </div>
                            <div>
                              <p className="text-slate-500 dark:text-slate-400 mb-1">Data</p>
                            ...
                            <div>
                              <p className="text-slate-500 dark:text-slate-400 mb-1">Horário</p>
                              <p className="text-slate-900 dark:text-white flex items-center gap-2">
                        ...
                        {upcoming && (
                          <span className="bg-blue-600 dark:bg-blue-500 text-white text-xs px-3 py-1 rounded-full">
                            Próxima
                          </span>
                        )}
                      </div>
